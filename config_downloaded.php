...
// CORS Headers for Capacitor / local execution
header("Access-Control-Allow-Origin: *");
header("Access-Control-Allow-Methods: GET, POST, OPTIONS");
header("Access-Control-Allow-Headers: Content-Type, Authorization, X-Shipper-Passcode");
...
// Passcode cho Shipper (Pincode để truy cập shipper.html)
define('SHIPPER_PASSCODE', 'Leo0301.');

// Password cho Chủ quán (Owner) để vào Thống kê
