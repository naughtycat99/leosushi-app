const SPECIAL_ROLL_OPTIONS = [
  { name: 'A. 4 Stk.', price: '5,50' },
...
const MENU_DATA = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: '76. Pad Thai', desc: 'Reisbandnudeln im heißen Wok mit Ei, frischem Gemüse gebraten, verfeinert mit vietnamesischen Kräutern, Erdnüssen und Röstzwiebeln, dazu:', descEn: 'Rice noodles stir-fried in a hot wok with egg, fresh vegetables, refined with Vietnamese herbs, peanuts and crispy onions, with:', price: '11,90', hasOptions: true, options: [
        { name: 'A. Gebackener Tofu', price: '11,90', vegetarian: true },
        { name: 'B. Hähnchenbrustfilet', price: '12,90' },
        { name: 'C. Gebackener Hähnchenbrustfilet', price: '12,90' },
        { name: 'D. Gegrilltes Hähnchen-Brustfilet', price: '13,90' },
  ...
  },
  {
    ...
    items: [
      { name: 'Naturell', groupTitle: 'Wasser/ Mineral Water', price: '2,50', hasOptions: true, options: [
        { name: '0,2l', price: '2,50' },
        { name: '0,4l', price: '3,90' },
        { name: '0,75l', price: '6,50' }
      ] },
      ...
      { name: 'Apfel', groupTitle: 'Säfte/ Juices', price: '3,50', hasOptions: true, options: [
        { name: '0,2l', price: '3,50' },
        { name: '0,4l', price: '5,50' }
      ] },
      ...
      { name: 'Tiger Bier Singapur', groupTitle: 'Bier', price: '4,50', hasOptions: true, options: [
        { name: '0,33l', price: '4,50' },
        { name: '0,5l', price: '5,50' }
      ] },
      ...
      { name: 'Grauburgunder Trocken', groupTitle: 'Weisswein', desc: 'Pinot Gris Dry', descEn: 'Pinot Gris Dry', price: '4,50', hasOptions: true, options: [
        { name: '0,2l', price: '4,50' },
        { name: '0,75l', price: '18,00' }
      ] },
...
if (typeof localStorage !== 'undefined') {
  const selectedBranchRaw = localStorage.getItem('leoSelectedBranch') || 'branch_flora';
  let selectedBranch = selectedBranchRaw;
  if (selectedBranchRaw && selectedBranchRaw.trim().startsWith('{')) {
    try {
      selectedBranch = JSON.parse(selectedBranchRaw).id || 'branch_flora';
    } catch (e) {
      selectedBranch = selectedBranchRaw;
    }
  }
  if (selectedBranch === 'branch_haupt') {
    // 1. Update Special Rolls prices
    const specialRollsCat = MENU_DATA.find(c => c.id === 'specialrolls');
    if (specialRollsCat) {
      specialRollsCat.categoryDesc = 'Alle Rolls Nr. Sp1-Sp16 erhältlich in: A 4 stk. €6,50 B 8 stk. €11,50';
      specialRollsCat.items.forEach(item => {
        if (item.options && item.options[0]) {
          item.options[0].price = '6,50';
        }
      });
    }

    // 2. Add Sa4 and Sa5 to Sashimi
    const sashimiCat = MENU_DATA.find(c => c.id === 'sashimi');
    if (sashimiCat) {
      sashimiCat.items.push(
        { name: 'Sa4. Sake Special (6 Stk.)', desc: 'angebratener Lachs mit Spezial-Soße', descEn: 'seared salmon with special sauce', price: '14,90' },
        { name: 'Sa5. Maguro Special (6 Stk.)', desc: 'angebratener Thunfisch mit ThunfischSpezial-Soße', descEn: 'seared tuna with tuna special sauce', price: '14,90' }
      );
    }

    // 3. Add 47. Sauer-Scharf-Suppe to Suppen
    const suppenCat = MENU_DATA.find(c => c.id === 'suppen');
    if (suppenCat) {
      if (!suppenCat.items.find(i => i.name.startsWith('47.'))) {
        suppenCat.items.push({
          name: '47. Sauer-Scharf-Suppe (B)',
          desc: 'Die Suppe wird mit frischen Zutaten zubereitet',
          descEn: 'The soup is made with fresh ingredients',
          price: '4,90'
        });
      }
    }

    // 4. Update Warme Gerichte (hauptspeisen) items entirely to match Leo_5.pdf (Cơ sở 2)
    const hauptspeisenCat = MENU_DATA.find(c => c.id === 'hauptspeisen');
    if (hauptspeisenCat) {
      hauptspeisenCat.categoryDesc = 'Gerichte Nr. 70-80 - nach Wahl mit: A. Gebackener Tofu €11,90 | B. Hähnchenbrustfilet €12,90 | C. Gebackener Hähnchenbrustfilet €12,90 | D. Gegrilltes Hähnchen-Brustfilet €13,90 | E. Ente Kross €14,90 | G. Garnelen €13,90 | R. Mariniertes Rindfleisch €13,90 | H. Gegrillter Lachs €15,90 | I. Gebackene Seitan mit Sesam €13,90. Currys/Soßen (70-76) werden mit Duftreis serviert. Pho (77) & Japanische Nudelsuppe (78) mà không cần cơm. Nudeln (82-85) & gebratener Reis (86) / Curries/Sauces (70-76) are served with fragrant rice. Pho (77) & Japanese noodle soup (78) without rice. Noodles (82-85) & fried rice (86)';
      hauptspeisenCat.items = [
        { name: '70. Roter Curry (a,d,n,i)', desc: 'Kokosmilch, rotes Curry, verschiedenes Gemüse und Reis, dazu:', descEn: 'Coconut milk, red curry, assorted vegetables and rice, with:', price: '11,90', hasOptions: true, options: [
          { name: 'A. Gebackener Tofu', price: '11,90', vegetarian: true },
          { name: 'B. Hähnchenbrustfilet', price: '12,90' },
          { name: 'C. Gebackener Hähnchenbrustfilet', price: '12,90' },
          { name: 'D. Gegrilltes Hähnchen-Brustfilet', price: '13,90' },
        ...
        { name: '71. Erdnuss (a,d,h,n)', desc: 'Cremige Kokosmilch-Erdnuss-Soße, verschiedenes Gemüse und Reis, dazu:', descEn: 'Creamy coconut-peanut sauce, assorted vegetables and rice, with:', price: '11,90', hasOptions: true, options: [
          { name: 'A. Gebackener Tofu', price: '11,90', vegetarian: true },
          { name: 'B. Hähnchenbrustfilet', price: '12,90' },
          { name: 'C. Gebackener Hähnchenbrustfilet', price: '12,90' },
          { name: 'D. Gegrilltes Hähnchen-Brustfilet', price: '13,90' },
        ...
        { name: '72. Mango-Curry (a,d,n,i)', desc: 'Feinwürzige Mango-Curry-Soße, verschiedenes Gemüse und Reis, dazu:', descEn: 'Spicy mango curry sauce, assorted vegetables and rice, with:', price: '11,90', hasOptions: true, options: [
          { name: 'A. Gebackener Tofu', price: '11,90', vegetarian: true },
          { name: 'B. Hähnchenbrustfilet', price: '12,90' },
          { name: 'C. Gebackener Hähnchenbrustfilet', price: '12,90' },
          { name: 'D. Gegrilltes Hähnchen-Brustfilet', price: '13,90' },
        ...
        { name: '73. Avocado Curry (a,d,n,i)', desc: 'Cremige Kokosmilch-Soße, grünes Curry, verschiedenes Gemüse und Duftreis, dazu:', descEn: 'Creamy coconut sauce, green curry, assorted vegetables and fragrant rice, with:', price: '11,90', hasOptions: true, options: [
          { name: 'A. Gebackener Tofu', price: '11,90', vegetarian: true },
          { name: 'B. Hähnchenbrustfilet', price: '12,90' },
          { name: 'C. Gebackener Hähnchenbrustfilet', price: '12,90' },
          { name: 'D. Gegrilltes Hähnchen-Brustfilet', price: '13,90' },
        ...
        { name: '74. Good Curry (a,d,n,i)', desc: 'Cremige Kokosmilch-Soße, Ingwer-Curry, verschiedenes Gemüse und Duftreis, dazu:', descEn: 'Creamy coconut sauce, ginger curry, assorted vegetables and fragrant rice, with:', price: '11,90', hasOptions: true, options: [
          { name: 'A. Gebackener Tofu', price: '11,90', vegetarian: true },
          { name: 'B. Hähnchenbrustfilet', price: '12,90' },
          { name: 'C. Gebackener Hähnchenbrustfilet', price: '12,90' },
          { name: 'D. Gegrilltes Hähnchen-Brustfilet', price: '13,90' },
        ...
        { name: '75. Leo Spezial-Soße (A,F)', desc: 'Frisches vietnamesisches Gemüse, pikante Soße, Knoblauch mit Duftreis, dazu:', descEn: 'Fresh Vietnamese vegetables, spicy sauce, garlic with fragrant rice, with:', price: '11,90', hasOptions: true, options: [
          { name: 'A. Gebackener Tofu', price: '11,90', vegetarian: true },
          { name: 'B. Hähnchenbrustfilet', price: '12,90' },
          { name: 'C. Gebackener Hähnchenbrustfilet', price: '12,90' },
          { name: 'D. Gegrilltes Hähnchen-Brustfilet', price: '13,90' },
        ...
        { name: '76. Süß-saure Soße (k)', desc: 'Fruchtige Süß-saure Soße, zubereitet mit frischer Ananas und Orange sowie Paprika und grünen Erbsen, dazu:', descEn: 'Fruity sweet and sour sauce prepared with fresh pineapple and orange, peppers, and green peas, with:', price: '11,90', hasOptions: true, options: [
          { name: 'A. Gebackener Tofu', price: '11,90', vegetarian: true },
          { name: 'B. Hähnchenbrustfilet', price: '12,90' },
          { name: 'C. Gebackener Hähnchenbrustfilet', price: '12,90' },
          { name: 'D. Gegrilltes Hähnchen-Brustfilet', price: '13,90' },
        ...
        { name: '77. Pho (b,F)', desc: 'Traditionelle vietnamesische Suppe mit Bandnudeln, frischem Ingwer und Kräutern, dazu:', descEn: 'Traditional Vietnamese soup with rice noodles, fresh ginger, and herbs, served with:', price: '11,90', hasOptions: true, options: [
          { name: 'A. Gebackener Tofu', price: '11,90', vegetarian: true },
          { name: 'B. Hähnchenbrustfilet', price: '12,90' },
          { name: 'C. Mariniertes Rindfleisch', price: '13,90' }
        ] },
        { name: '78. Japanische Nudelsuppe (b,g)', desc: 'Japanische Nudeln, Hühnerbrühe, Gemüse und Kräuter, dazu:', descEn: 'Japanese noodles, chicken broth, vegetables and herbs, with:', price: '11,90', hasOptions: true, options: [
          { name: 'A. Gebackener Tofu', price: '11,90', vegetarian: true },
          { name: 'B. Hähnchenbrustfilet', price: '12,90' },
          { name: 'C. Gebackener Hähnchenbrustfilet', price: '12,90' },
          { name: 'D. Gegrilltes Hähnchen-Brustfilet', price: '13,90' },
        ...
        { name: '79. Pho Tron (a,b)', desc: 'Reisbandnudeln in Kokosmilch, rotem Curry, Salat, Erdnüssen, Röstzwiebeln und Kräutern, dazu:', descEn: 'Rice noodles in coconut milk, red curry, salad, peanuts, fried onions and herbs, served with:', price: '11,90', hasOptions: true, options: [
          { name: 'A. Gebackener Tofu', price: '11,90', vegetarian: true },
          { name: 'B. Hähnchenbrustfilet', price: '12,90' },
          { name: 'C. Gebackener Hähnchenbrustfilet', price: '12,90' },
          { name: 'D. Gegrilltes Hähnchen-Brustfilet', price: '13,90' },
        ...
        { name: '80. Udon Coco (d,n)', desc: 'Japanische Nudeln in Kokosmilch, Masaman-Curry, Salat, Erdnüssen, Röstzwiebeln und Kräutern, dazu:', descEn: 'Japanese noodles in coconut milk, masaman curry, salad, peanuts, crispy onions and herbs, with:', price: '11,90', hasOptions: true, options: [
          { name: 'A. Gebackener Tofu', price: '11,90', vegetarian: true },
          { name: 'B. Hähnchenbrustfilet', price: '12,90' },
          { name: 'C. Gebackener Hähnchenbrustfilet', price: '12,90' },
          { name: 'D. Gegrilltes Hähnchen-Brustfilet', price: '13,90' },
        ...
        { name: '81. Bun Bo Nam Bo (e,h,n,i)', desc: 'Typisch südvietnamesische Esskultur mit dünnen Reisbandnudeln, frischem Salat, Erdnüssen, Kräutern und hausgemachtem Limetten-Dressing, dazu:', descEn: 'Typical South Vietnamese cuisine with thin rice noodles, fresh salad, peanuts, herbs, and homemade lime dressing, served with:', price: '11,90', hasOptions: true, options: [
          { name: 'A. Gebackener Tofu', price: '11,90', vegetarian: true },
          { name: 'B. Hähnchenbrustfilet', price: '12,90' },
          { name: 'C. Mariniertes Rindfleisch', price: '13,90' },
          { name: 'D. Nem Ha Noi (3 Stk.)', price: '12,90' }
        ] },
        { name: '82. Udon Yaki (a,f)', desc: 'Udon-Nudeln im heißen Wok mit Ei, frischem Gemüse gebraten, verfeinert mit vietnamesischen Kräutern, Erdnüssen und Röstzwiebeln, dazu:', descEn: 'Udon noodles stir-fried in a hot wok with egg, fresh vegetables, refined with Vietnamese herbs, peanuts and crispy onions, with:', price: '11,90', hasOptions: true, options: [
          { name: 'A. Gebackener Tofu', price: '11,90', vegetarian: true },
          { name: 'B. Hähnchenbrustfilet', price: '12,90' },
          { name: 'C. Gebackener Hähnchenbrustfilet', price: '12,90' },
          { name: 'D. Gegrilltes Hähnchen-Brustfilet', price: '13,90' },
        ...
        { name: '83. Pad Thai (c,n)', desc: 'Reisbandnudeln im heißen Wok mit Ei, frischem Gemüse gebraten, verfeinert mit vietnamesischen Kräutern, Erdnüssen und Röstzwiebeln, dazu:', descEn: 'Rice noodles stir-fried in a hot wok with egg and fresh vegetables, refined with Vietnamese herbs, peanuts and crispy onions, with:', price: '11,90', hasOptions: true, options: [
          { name: 'A. Gebackener Tofu', price: '11,90', vegetarian: true },
          { name: 'B. Hähnchenbrustfilet', price: '12,90' },
          { name: 'C. Gebackener Hähnchenbrustfilet', price: '12,90' },
          { name: 'D. Gegrilltes Hähnchen-Brustfilet', price: '13,90' },
        ...
        { name: '84. My Xao (c,n)', desc: 'Gebratene Eiernudeln (Weizen) mit Ei, Porree, Chinakohl, Möhren und Sojasprossen, dazu:', descEn: 'Stir-fried egg noodles (wheat) with egg, leek, Chinese cabbage, carrots, and bean sprouts, served with:', price: '11,90', hasOptions: true, options: [
          { name: 'A. Gebackener Tofu', price: '11,90', vegetarian: true },
          { name: 'B. Hähnchenbrustfilet', price: '12,90' },
          { name: 'C. Gebackener Hähnchenbrustfilet', price: '12,90' },
          { name: 'D. Gegrilltes Hähnchen-Brustfilet', price: '13,90' },
        ...
        { name: '85. Pho Xao (c,n)', desc: 'Gebratene Reisbandnudeln mit Ei, Pak Choi, Porree, Möhren, Sojasprossen und Tamarindensoße, verfeinert mit Röstzwiebeln und Erdnüssen, wahlweise mit:', descEn: 'Stir-fried rice noodles with egg, pak choi, leek, carrots, bean sprouts and tamarind sauce, refined with crispy fried onions and peanuts, optionally with:', price: '11,90', hasOptions: true, options: [
          { name: 'A. Gebackener Tofu', price: '11,90', vegetarian: true },
          { name: 'B. Hähnchenbrustfilet', price: '12,90' },
          { name: 'C. Gebackener Hähnchenbrustfilet', price: '13,90' },
          { name: 'D. Gegrilltes Hähnchen-Brustfilet', price: '14,90' },
          { name: 'E. Ente Kross', price: '15,90' },
          { name: 'G. Garnelen', price: '14,90' },
          { name: 'R. Mariniertes Rindfleisch', price: '14,90' },
          { name: 'H. Gegrillter Lachs', price: '16,90' },
          { name: 'I. Gebackene Seitan mit Sesam', price: '14,90', vegetarian: true }
        ], useBulletPoints: true },
        { name: '86. Com Rang', desc: 'Gebratener Reis mit Eier-Omelette, frischem Gemüse, Erbsen, Bohnen, Karotten, Mais und Zwiebeln, dazu:', descEn: 'Fried rice with egg omelette, fresh vegetables, peas, beans, carrots, corn, and onions, served with:', price: '11,90', hasOptions: true, options: [
          { name: 'A. Gebackener Tofu', price: '11,90', vegetarian: true },
          { name: 'B. Hähnchenbrustfilet', price: '12,90' },
          { name: 'C. Gebackener Hähnchenbrustfilet', price: '13,90' },
          { name: 'D. Gegrilltes Hähnchen-Brustfilet', price: '13,90' },
