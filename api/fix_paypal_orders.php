 ...
 * 
 * Logic: If payment_method = 'paypal' => set payment_status = 'paid'
 * Also updates the summary JSON to include payment_status = 'paid'
 * 
...
// Step 1: Find all PayPal orders with payment_status != 'paid'
...
while ($row = $result->fetch_assoc()) {
    ...
    echo "Order: {$orderId} | Status: {$status} | Payment: {$row['payment_status']}\n";
