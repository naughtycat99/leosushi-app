...
function getItemImage(categoryId, itemName) {
  ...
  const CAT_IMAGES = {
    vorspeisen: 'assets/477094040_943569787952278_5086544566261599514_n.webp', // Spring rolls
    salate: 'assets/salad_new_banner.png', // Salad with shrimp
    suppen: 'assets/soup_new_banner.png', // Red curry soup
    hauptspeisen: 'assets/474747577_583620977982257_5069519367255368765_n.webp', // Noodles/rice bowl
    teriyaki: 'assets/Image_Teriyaki-Tuna-Tataki-Flatbread_Teriyaki-Sauce_RT_SV_BKP_092921-5.webp', // Teriyaki tuna
    pokebowl: 'assets/sake-poke-bowl-with-rice-or-salad.webp', // Poke bowl
    maki: 'assets/banh-mi-shushi.webp', // Maki sushi with roe
    nigiri: 'assets/526755952_122145800660617493_8652643431098218812_n.webp', // Nigiri sushi
    insideout: 'assets/678a39d1596da842cc63c03c 1.webp', // Inside out sushi
    sashimi: 'assets/498665275_17863755624399871_7773501872179564451_n 1.webp', // Sashimi platter
    crunchy: 'assets/10 3498178 1.webp', // Crunchy sushi rolls
    bigrolls: 'assets/bua-tiec-shushi.webp', // Big rolls platter
    minirolls: 'assets/vegan-crunchiy-california-rolls-with-tofu-08c0ea7eeb121ea89055bbc92a83a9bd 1.webp', // Mini rolls
    specialrolls: 'assets/close-up-sushi-served-table 1.webp', // Special rolls
    firenigiri: 'assets/107321305_156996452705031_5135397567937722939_n.webp', // Fire nigiri
    temaki: 'assets/dsc06551_master.webp', // Temaki with roe
    sushimenu: 'assets/bua-tiec-shushi.webp', // Sushi menu platter
    dessert: 'assets/474145891_579480641729624_2668845756094693673_n.webp', // Dessert bowls
    beilagen: 'assets/524354655_17842903512542764_6403983830540063508_n11 1.webp' // Side dishes
  };
  return CAT_IMAGES[categoryId] || 'assets/close-up-sushi-served-table 1.webp';
}
...
function renderMenuItems(categoryTitle) {
  ...
  if (categoryHeroImage) {
    const heroImageSrc = category.items[0]?.image || getItemImage(category.id, category.items[0]?.name) || 'assets/close-up-sushi-served-table 1.webp';
...
function setupGallery() {
  ...
  const images = [
    { src: "assets/close-up-sushi-served-table 1.webp", alt: "Sushi Auswahl" },
    { src: "assets/bua-tiec-shushi.webp", alt: "Sushi Teller" },
    { src: "assets/474747577_583620977982257_5069519367255368765_n.webp", alt: "Warme Speise" },
    { src: "assets/498665275_17863755624399871_7773501872179564451_n 1.webp", alt: "Set Menu" },
    { src: "assets/526755952_122145800660617493_8652643431098218812_n.webp", alt: "Detail 1" },
    { src: "assets/107321305_156996452705031_5135397567937722939_n.webp", alt: "Detail 2" },
    { src: "assets/Image_Teriyaki-Tuna-Tataki-Flatbread_Teriyaki-Sauce_RT_SV_BKP_092921-5.webp", alt: "Signature Roll" },
    { src: "assets/banh-mi-shushi.webp", alt: "Nigiri" },
    { src: "assets/sake-poke-bowl-with-rice-or-salad.webp", alt: "Poke Bowl" },
    { src: "assets/474145891_579480641729624_2668845756094693673_n.webp", alt: "Dessert" },
    { src: "assets/678a39d1596da842cc63c03c 1.webp", alt: "Ambiente 1" },
    { src: "assets/dsc06551_master.webp", alt: "Ambiente 2" },
    { src: "assets/10 3498178 1.webp", alt: "Ambiente 3" },
    { src: "assets/477094040_943569787952278_5086544566261599514_n.webp", alt: "Chef Special" },
  ...
  return `
    <div class="bill-page">
      ...
      <div class="bill-section">
        ...
        ${estimatedTimeText ? `
        <div class="order-info" style="background: #f8f8f8; padding: 10px; border: 2px solid #333; margin: 10px 0; text-align: center;">
          <div style="font-weight: bold; font-size: 16px; margin-bottom: 4px;">GEPLANT FÜR (HẸN GIỜ):</div>
          <div style="font-weight: bold; font-size: 24px;">${estimatedTimeText} Uhr</div>
        </div>
        ` : ''}
  ...
  return `
    <div class="bill-page">
      ...
      <div class="bill-section">
        ...
        ` : ''}
        ${estimatedTimeText ? `
        <div class="order-info" style="background: #eee; padding: 12px; border: 3px solid #000; margin: 10px 0; text-align: center;">
          <div style="font-weight: bold; font-size: 18px; margin-bottom: 5px;">GEPLANT FÜR (GIỜ HẸN):</div>
          <div style="font-weight: bold; font-size: 28px;">${estimatedTimeText} Uhr</div>
        </div>
        ` : `
        <div class="order-info">
          <span>${orderTime}</span>
