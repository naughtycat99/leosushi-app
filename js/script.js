...
function sendCustomerConfirmationEmail(orderData, deliveryAddress, isAdminConfirmed = false, customEstimatedTime = null) {
  ...
  const templateParams = {
    ...
    restaurant_phone: (orderData.branch_id === 'branch_haupt' || orderData.branchId === 'branch_haupt' || (orderData.summary && orderData.summary.branch && orderData.summary.branch.id === 'branch_haupt') || (orderData.branch && orderData.branch.id === 'branch_haupt')) ? '030 55617056' : '030 37476736',
    ...
    <div class="bill-page">
      ...
      <div class="bill-header">
        ...
        <div class="restaurant-info">
          ...
          ${isHauptBranch ? '03055617056' : '03037476736'}
        </div>
      </div>
...
function sendReservationEmail(reservationData) {
  ...
  const templateParams = {
    ...
    restaurant_phone: (reservationData.branch_id === 'branch_haupt' || reservationData.branchId === 'branch_haupt' || (reservationData.branch && reservationData.branch.id === 'branch_haupt')) ? '030 55617056' : '030 37476736'
  };
